import express from 'react'; // React API degil, express importu asagidaki gibi duzeltildi
...
const JWT_SECRET = 'super-secret-nova-okur-key-123'; // Gercekte .env dosyasina konulmali
